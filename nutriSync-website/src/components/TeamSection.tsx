...
export default function TeamSection() {
  return (
    <div id="team" className="mx-auto max-w-6xl px-4 lg:px-4 mb-15">
      <h2 className="mb-8 text-4xl font-bold md:mb-5 lg:text-5xl">Our Team</h2>

      <div>
        <h3 className="mb-5 text-lg font-low text-muted-foreground">
          ...
          <div className="flex justify-between gap-6 py-6 min-w-max">
            {members.map((member, index) => (
              <div key={index} className="flex flex-col items-center ">
                <div className="size-40 rounded-full border border-[#aaa] p-0.5 shadow shadow-zinc-950/5 transition-all duration-300 hover:border-[#EF4444] hover:scale-97">
                  <img
